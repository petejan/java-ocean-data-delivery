...
c Another version "h" uses Mike Gregg's ASP Ts data at 6m depth, prepared by Hemantha Wijesekera
...
c open input/output files
      open(unit=3,file='c:\digital_e\bulk3_0\test3_0.txt') ! 4-day coare test data
      open(unit=4,file='c:\digital_e\bulk3_0\tst3_0af.out')  ! output no wave data used
c
...
c
      index=0
      do while (.not. eof(3))    !*****start data input loop*****
...
c
700   read(3,*)xtime,u,ts,t,q,rs,rl,rain,xlat,xlon,hwt
c
