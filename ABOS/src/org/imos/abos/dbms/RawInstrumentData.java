...
public class RawInstrumentData  implements Cloneable
{
    ...
    private static Logger logger = Logger.getLogger(RawInstrumentData.class.getName());
    ...
    private static String insertSQL  = "insert into raw_instrument_data"
            + "("
            + " source_file_id,"
            + " instrument_id,"
            + " mooring_id,"
    ...
    {
        return "update raw_instrument_data set "
                + " source_file_id = ?,"
                //+ " instrument_id = ?,"
                + " mooring_id = ?,"
                //+ " data_timestamp = ?,"
    ...
    {
        return "delete from raw_instrument_data"
                + " where instrument_id = ?"
                + " and data_timestamp = ?"
                + " and parameter_code = ?"
                ;
    ...
    private static ArrayList<RawInstrumentData> doSelect(String sql)
    {
        ArrayList<RawInstrumentData> items = new ArrayList();
     ...
     * @return
     */
    public static ArrayList<RawInstrumentData> selectAll()
    {
        return doSelect( selectSQL
                        + getDefaultSortOrder());
    }

    public static ArrayList<RawInstrumentData> selectByInstrument(Integer ID)
    {
        return doSelect( selectSQL
                        + " where instrument_id = "
                        + ID
    ...
    public static ArrayList<RawInstrumentData> selectBySourceFile(Integer ID)
    {
        return doSelect( selectSQL
    ...
    public static ArrayList<RawInstrumentData> selectByMooring(String ID)
    {
        return doSelect( selectSQL
                        + " where mooring_id = "
    ...
    public static ArrayList<RawInstrumentData> selectByParameterCode(String ID)
    {
        return doSelect( selectSQL
    ...
    public static ArrayList<RawInstrumentData> selectByParameterCodeAndMooring(String param, String mooring)
    {
        return doSelect( selectSQL
                        + " where mooring_id = "
     ...
     */
    public static ArrayList<RawInstrumentData> selectHourDataForInstrumentAndMooringAndParameter(Integer insID, String moorID, String paramCode)
    {
