...
public class ParameterCodesTable extends EditableBaseTable
{
    public ParameterCodesTable()
    {
        super();
    }

    ParameterCodesCollection collection = new ParameterCodesCollection();
    ...
    public void initialise()
    {
        ...
        setTitle("List of Parameter Codes" );
