        ...
        implements EditableTableInterface, ExtendedTableMetaData
{
    ...
    {
        rows = InstrumentDataFile.selectAll();
    }

    public void loadDataFilesForInstrument()
    {
        if(parentInstrument != null)
            rows = InstrumentDataFile.selectDataFilesForInstrument(parentInstrument.getInstrumentID());
    }
    ...
    {
        return InstrumentDataFile.getColumnName( column );
    }
    ...
    {
        return InstrumentDataFile.getColumnClass( column);
    }

    public int getColumnCount()
    {
        return InstrumentDataFile.getColumnCount();
    }
    ...
    {
        InstrumentDataFile row = rows.get(aRow);
    ...
    {
        InstrumentDataFile newRow = new InstrumentDataFile();
        newRow.setNew(true);

        InstrumentDataForm form = new InstrumentDataForm();
    ...
    public boolean saveEditedRow(int row)
    {
        try
        {
            InstrumentDataFile editingRow = rows.get( row );
    ...
    public void storeRowBeforeEditing(int row)
    {
        try
        {
            savedRow =  (InstrumentDataFile) ((InstrumentDataFile)rows.get(row)).clone();
        }
    ...
    {
        return InstrumentDataFile.getColumnWidths();
    }
    ...
    {
        InstrumentDataFile row = rows.get(intValue);
