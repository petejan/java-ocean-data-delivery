...
public class ParameterSelectorCombo extends BasicCombo
{

    private static Logger logger = Logger.getLogger( ParameterSelectorCombo.class.getName());
    JComboBox combo = null;

    private basicField descriptionField = null;

    ArrayList<ParameterCodes> codes = null;
    private ParameterCodes selected = null;

    public ParameterSelectorCombo()
    {
        super();
        setLabel("Parameter");
        ...
        codes = ParameterCodes.selectAllActiveCodes();
        ...
        if(codes != null && codes.size() > 0)
        {
            ...
            {
                ParameterCodes ps = codes.get(i);
                combo.addItem(ps.getParameterCode() + " - " + ps.getDescription());
            }
        }
        else
        {
                ...
                if(e.getStateChange() == ItemEvent.SELECTED)
                {
                    ...
                    else
                    {
                        ...
                        if(selected != null)
                        {
                            ...
                            firePropertyChange("PARAM_SELECTED", null, selected);
                        }
                        else
                        {
     ...
     * @return
     */
    public ParameterCodes getSelectedParameter()
    {
