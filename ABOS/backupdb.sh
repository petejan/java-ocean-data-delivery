...
#pg_dump -Fc -v -T raw_instrument_data_fluxpulse1 -T raw_instrument_data_sofs5 -T raw_instrument_data_sofs4 -T raw_instrument_data_sofs3 -T raw_instrument_data_sofs1 -T raw_instrument_data_sofs2 -T raw_instrument_data_sofs1 -T raw_instrument_data_pulse ABOS -f $1/ABOS-part-${date}.backup.z
