...
import org.imos.dwm.dbms.Array2DInstrumentData;
import org.imos.dwm.dbms.ArrayInstrumentData;
import org.imos.dwm.dbms.Instrument;
import org.imos.dwm.dbms.Mooring;
import org.imos.dwm.dbms.RawInstrumentData;
import org.imos.dwm.netcdf.NetCDFfile;
...
//                ok = raw.insert();
    ...
    public void createNetCDF() throws ParseException
    {
        ...
        String filename = ndf.getFileName(inst, dataStartTime, dataEndTime, "raw", "W", null);
        ...
        try
        {
            ...
            ndf.addGroupAttribute(null, new Attribute("abstract", "Oceanographic and meteorological data from the Southern Ocean Time Series observatory in the Southern Ocean southwest of Tasmania\nThis wave data was collected using a AXYS technologies TriAXYS OEM wave sensor deployed on a 3m WHOI surface float"));
