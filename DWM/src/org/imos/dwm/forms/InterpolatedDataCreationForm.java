 ...
 * @author peter
 */
public class InterpolatedDataCreationForm extends MemoryWindow implements DataProcessor
{
    ...
    public InterpolatedDataCreationForm()
    {
    ...
    private void initComponents()
    {
        ...
        targetParameterSelector = new org.imos.dwm.dbms.fields.ParameterSelectorCombo();
        sourceParameterSelector = new org.imos.dwm.dbms.fields.ParameterSelectorCombo();
    ...
    public void calculateDataValues()
    {
        ...
        if(selectionSet != null && selectionSet.size() > 0)
        {
            ...
            for(long t = s; t < end.getTime(); t += (60 * 60 * 1000))
            {
                ...
                pid.setParameterValue(function.value((double)t));
    ...
    */
    ...
    private org.imos.dwm.dbms.fields.ParameterSelectorCombo sourceParameterSelector;
    private org.imos.dwm.dbms.fields.InstrumentSelectorCombo targetInstrumentCombo;
    private org.imos.dwm.dbms.fields.ParameterSelectorCombo targetParameterSelector;
